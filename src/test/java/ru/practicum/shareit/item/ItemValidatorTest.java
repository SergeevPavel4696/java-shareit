...
public class ItemValidatorTest {
    ...
    public void itemDtoValidateTest() {
        assertThrows(ValidationException.class, () -> ItemValidator.validate(itemWithIncorrectName, 1));
        assertThrows(ValidationException.class, () -> ItemValidator.validate(itemWithIncorrectDescription, 1));
        assertThrows(ServerError.class, () -> ItemValidator.validate(itemWithIncorrectDescription, null));
    }
}
