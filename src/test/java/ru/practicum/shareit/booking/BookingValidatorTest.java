...
public class BookingValidatorTest {
    ...
    BookingEntry bookingEntryWithoutStart = new BookingEntry(1, null, end, item.getId(), booker.getId(), WAITING);
    BookingEntry bookingEntryWithoutEnd = new BookingEntry(1, start, null, item.getId(), booker.getId(), WAITING);
    BookingEntry bookingEntryWithoutItem = new BookingEntry(1, start, end, null, booker.getId(), WAITING);
    BookingEntry bookingEntryPastDate = new BookingEntry(1,
            LocalDateTime.of(2020,1,1,0,0,0),
            LocalDateTime.of(2020,2,1,0,0,0),
            item.getId(), booker.getId(), WAITING);
    BookingEntry bookingEntryWithIncorrectDate = new BookingEntry(1, end, start, null, booker.getId(), WAITING);
